...
set_data_paths <- function(custom.path = NULL) {
  ...
  # (as instructed by Edward Byers on Microsoft Teams on 30 May 2023 09:53)
  path.eucab.meta <<- here("data", "vetting_flags_global_regional_combined_20230512_v4.xlsx") 
